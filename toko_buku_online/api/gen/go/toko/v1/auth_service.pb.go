...
func (x *RegisterRespone) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterRespone) ProtoMessage() {}

func (x *RegisterRespone) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_auth_service_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterRespone.ProtoReflect.Descriptor instead.
func (*RegisterRespone) Descriptor() ([]byte, []int) {
	return file_api_proto_auth_service_proto_rawDescGZIP(), []int{3}
}

func (x *RegisterRespone) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_api_proto_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x1capi/proto/auth_service.proto\x12\atoko.v1\"@\n" +
	...
	"\x0fRegisterRespone\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2\x85\x01\n" +
	"\vAuthService\x126\n" +
	"\x05Login\x12\x15.toko.v1.LoginRequest\x1a\x16.toko.v1.LoginResponse\x12>\n" +
	"\bRegister\x12\x18.toko.v1.RegisterRequest\x1a\x18.toko.v1.RegisterResponeB*Z(toko_buku_online/api/gen/go/toko/v1;tokob\x06proto3"
...
var file_api_proto_auth_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_proto_auth_service_proto_goTypes = []any{
	(*LoginRequest)(nil),    // 0: toko.v1.LoginRequest
	(*LoginResponse)(nil),   // 1: toko.v1.LoginResponse
	(*RegisterRequest)(nil), // 2: toko.v1.RegisterRequest
	(*RegisterRespone)(nil), // 3: toko.v1.RegisterRespone
}
var file_api_proto_auth_service_proto_depIdxs = []int32{
	0, // 0: toko.v1.AuthService.Login:input_type -> toko.v1.LoginRequest
	2, // 1: toko.v1.AuthService.Register:input_type -> toko.v1.RegisterRequest
	1, // 2: toko.v1.AuthService.Login:output_type -> toko.v1.LoginResponse
	3, // 3: toko.v1.AuthService.Register:output_type -> toko.v1.RegisterRespone
