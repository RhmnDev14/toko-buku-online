...
const file_api_proto_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x1capi/proto/auth_service.proto\x12\atoko.v1\x1a\x1bgoogle/protobuf/empty.proto\"F\n" +
	...
	"\x04role\x18\x04 \x01(\tR\x04role2\x83\x01\n" +
	"\vAuthService\x126\n" +
	"\x05Login\x12\x15.toko.v1.LoginRequest\x1a\x16.toko.v1.LoginResponse\x12<\n" +
	"\bRegister\x12\x18.toko.v1.RegisterRequest\x1a\x16.google.protobuf.EmptyB*Z(toko_buku_online/api/gen/go/toko/v1;tokob\x06proto3"
...
var file_api_proto_auth_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_api_proto_auth_service_proto_depIdxs = []int32{
	...
	3, // 3: toko.v1.AuthService.Register:output_type -> google.protobuf.Empty
