...
const (
	CategoryService_CreateCategory_FullMethodName = "/toko.v1.CategoryService/CreateCategory"
	CategoryService_GetCategories_FullMethodName  = "/toko.v1.CategoryService/GetCategories"
	CategoryService_UpdateCategory_FullMethodName = "/toko.v1.CategoryService/UpdateCategory"
	CategoryService_DeleteCategory_FullMethodName = "/toko.v1.CategoryService/DeleteCategory"
)
...
type CategoryServiceClient interface {
	...
	GetCategories(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoryResponseList, error)
	UpdateCategory(ctx context.Context, in *CategoryUpdateRequest, opts ...grpc.CallOption) (*CategoryResponse, error)
	DeleteCategory(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoryResponse, error)
}
...
func (c *categoryServiceClient) GetCategories(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoryResponseList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *categoryServiceClient) UpdateCategory(ctx context.Context, in *CategoryUpdateRequest, opts ...grpc.CallOption) (*CategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoryResponse)
...
func (c *categoryServiceClient) DeleteCategory(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoryResponse)
...
type CategoryServiceServer interface {
	...
	GetCategories(context.Context, *Empty) (*CategoryResponseList, error)
	UpdateCategory(context.Context, *CategoryUpdateRequest) (*CategoryResponse, error)
	DeleteCategory(context.Context, *Empty) (*CategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) GetCategories(context.Context, *Empty) (*CategoryResponseList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCategories not implemented")
}
func (UnimplementedCategoryServiceServer) UpdateCategory(context.Context, *CategoryUpdateRequest) (*CategoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCategory not implemented")
}
func (UnimplementedCategoryServiceServer) DeleteCategory(context.Context, *Empty) (*CategoryResponse, error) {
...
func _CategoryService_DeleteCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).DeleteCategory(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "toko.v1.CategoryService",
